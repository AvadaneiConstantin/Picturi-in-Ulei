			...
			// animatie la pret picturi

			function mouseEnterAnimationPret() {
    document.getElementById("backgroundPretPictura").style.display = "inline";
}

function mouseEnterAnimationBackground() {
    document.getElementById("backgroundPretPictura").style.animation = "mouseEnterAnimationBackground .5s forwards ";
    document.getElementById("pretPictura").style.display = "none";
}

function mouseLeaveAnimationBackground() {
    document.getElementById("backgroundPretPictura").style.animation = "mouseLeaveAnimationBackground .6s forwards ";
    document.getElementById("pretPictura").style.display = "inline";
    document.getElementById("backgroundPretPictura").style.display = "none";
}

// functie filterScale pe mouseover picturi
function filterScaleNone() {
    document.getElementById("picturaUnu").style.filter = "grayscale(0)"; 
    document.getElementById("picturaUnu").style.transform = "scale(1.4)";
}

function filterScaleActiv() {
    document.getElementById("picturaUnu").style.filter = "sepia(80%)";
    document.getElementById("picturaUnu").style.transform = "scale(1)";
}
